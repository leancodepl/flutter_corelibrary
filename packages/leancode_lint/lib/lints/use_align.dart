...
class UseAlign extends AnalysisRule {
  UseAlign()
    : super(
        name: code.name,
        description:
            'Replace Container used solely for alignment with the dedicated Align widget. '
            'Using Align communicates intent and avoids unnecessary Container properties.',
      );
